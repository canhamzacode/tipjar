...
const TipButtons = () => {
  return (
    <div className="flex justify-center space-x-8 mb-8">
      <button className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-6 py-3 rounded-lg flex items-center space-x-2 text-lg font-semibold hover:bg-gradient-to-r hover:from-teal-500 hover:to-teal-600 transition-all duration-300">
